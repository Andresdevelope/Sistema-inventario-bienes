            ...
            <form method="GET" action="{{ route('bienes.index') }}" class="space-y-3">
                ...
                <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('bienes.index') }}" class="inline-flex items-center rounded-2xl border border-slate-300 bg-white px-4 py-2 text-[12px] font-semibold text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 cursor-pointer">
                            Limpiar filtros
                        </a>
